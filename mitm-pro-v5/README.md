...
**📖 [Hướng dẫn chi tiết cài đặt và sử dụng trên Kali Linux → KALI_SETUP.md](KALI_SETUP.md)**
...
Script tự động cài tất cả: Bettercap, nmap, tcpdump, Responder, và Python packages.

**📖 Xem hướng dẫn chi tiết tại [KALI_SETUP.md](KALI_SETUP.md)**
